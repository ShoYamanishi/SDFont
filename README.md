...
The fonts are usually found in `/usr/share/fonts, /usr/local/fonts` etc on Linux, and `/System/Library/Fonts/` on MacOS. The demo program was tested with the normal Helvetica font. **Please check the license and the terms & conditions for each font file, especially the embedding restrictions.**

```
./sdfont_commandline -verbose -font_path /System/Library/Fonts/Helvetica.ttc -char_code_range 0X0000-0X0100 -texture_size 1024 -num_threads 32 ./signed_dist_font
```
...
**Copyright Notice:** 
Helvetica is a registered trademark of Linotype AG. No embedding restrictions. © 1990-2006 Apple Computer Inc. © 1981 Linotype AG © 1990-91 Type Solutions Inc.
